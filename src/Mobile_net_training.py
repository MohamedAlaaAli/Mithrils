...
model = MobileNetv3(in_channels=3, num_classes=10).to('cuda')
...
results_file = "../Results/cifar10v2_Mobnet_training_results.csv"
...
for epoch in range(epochs):
    ...
    model_save_path = os.path.join(save_dir, f"mobilenet_cifar10v2_epoch{epoch}.pth")

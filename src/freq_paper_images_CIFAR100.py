...
model.load_state_dict(torch.load("../saved_models/cifar100/resnet34_cifar100_epoch10.pth"))
model.to('cuda')
...
results_file = "../Results/training_results_cifar100_ori_3nd.csv"
...
for epoch in range(epochs):
    ...
    model_save_path = os.path.join(save_dir, f"resnet34_cifar100_ori_3nd_epoch{epoch+1}.pth")
